...
<footer class="section-footer bg-dark white">
    <div class="container">
            ...
            <div class="row">
                ...
                <aside class="col-sm-3">
                    <article class="white">
                        ...
                        <p>
                            <strong>Phone: </strong> +9779844880726
                            <br>
                            <strong>Email: </strong> praveenjaisy1111@outlook.com
                        </p>
        ...
        <section class="footer-bottom row border-top-white">
            <div class="col-sm-6">
                <p class="text-white-50"> Made by praveenpcpc</p>
            </div>
            <div class="col-sm-6">
                <p class="text-md-right text-white-50">
                    Copyright &copy
                    <br>
                    <a href="http://bootstrap-ecommerce.com" class="text-white-50">praveenjaisy</a>
                </p>
            </div>
        </section>
        <!-- //footer-top -->
